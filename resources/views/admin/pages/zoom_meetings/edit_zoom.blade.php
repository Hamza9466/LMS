...
<div class="container py-5">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h3 class="mb-0">Edit Zoom Meeting</h3>
  ...
  <form method="POST" action="{{ route($base.'.update', $meeting) }}" enctype="multipart/form-data" class="mt-3">
    @csrf
    @method('PUT')
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        ...
        <input type="text"
               name="meeting_id"
               value="{{ old('meeting_id', $meeting->meeting_id) }}"
               class="form-control border-1 bg-white"
               required>
      </div>
    </div>
    ...
    <div class="row g-3 mt-2">
      <div class="col-md-6">
        ...
        <input type="datetime-local"
               name="starts_at"
               value="{{ old('starts_at', optional($meeting->starts_at)->format('Y-m-d\TH:i')) }}"
               class="form-control border-1 bg-white"
               required>
      </div>
    ...
    {{-- Row 3: Current Image | Replace Thumbnail --}}
    <div class="row g-3 mt-2">
      <div class="col-md-6">
        <label class="form-label d-block">Current Image</label>
        @if($meeting->image_path)
          <img src="{{ asset($meeting->image_path) }}"
               alt="{{ $meeting->title }}"
    ...
    {{-- Row 4: Published | (full-width) Description --}}
    <div class="row g-3 mt-2">
      <div class="col-md-6 d-flex align-items-end">
        <div class="form-check mt-4">
          <input class="form-check-input"
                 ...
                 name="is_published"
                 value="1"
                 {{ old('is_published', $meeting->is_published) ? 'checked' : '' }}>
      ...
      <div class="col-md-12">
        ...
        <textarea name="description"
                  rows="4"
                  class="form-control border-1 bg-white"
                  placeholder="Update details about the meeting...">{{ old('description', $meeting->description) }}</textarea>
      </div>
    </div>
