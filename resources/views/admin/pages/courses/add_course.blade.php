                    ...
                    <form method="POST" enctype="multipart/form-data"
                        ...
                        <div class="mt-3">
                            ...
                            <select name="category_id" class="form-select @error('category_id') is-invalid @enderror">
                                ...
                                <option value="{{ $cat->id }}" {{ (string)old('category_id', $course->category_id ?? '')
                        ...
                        <div class="row g-3 mt-1">
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Promo Video URL (YouTube/Vimeo)</label>
                                <input type="url" name="promo_video_url"
                                    class="form-control @error('promo_video_url') is-invalid @enderror"
                        ...
                        <div class="row g-3 mt-1">
                            <div class="col-md-2 d-flex align-items-end">
                                <div class="form-check mt-2">
                                    <input type="checkbox" class="form-check-input" name="is_free" id="is_free" {{ $free
                                        ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.01" name="compare_at_price"
                                    ...
                                    value="{{ old('compare_at_price', $course->compare_at_price ?? '') }}" {{ $free
                                    ? 'disabled' : '' }}>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" step="0.01" name="discount_price"
                                    ...
                                    value="{{ old('discount_price', $course->discount_price ?? '') }}" {{ $free
                                    ? 'disabled' : '' }}>
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-3">
                                ...
                                <select name="status" class="form-select @error('status') is-invalid @enderror">
                                    <option value="draft" {{ old('status', $course->status ?? '') == 'draft' ?
                                        'selected' : '' }}>Draft</option>
                                    <option value="published" {{ old('status', $course->status ?? '') == 'published' ?
                        ...
                        <div class="mt-3">
                            ...
                            <select name="teacher_id"
                                class="form-select border-1 bg-white @error('teacher_id') is-invalid @enderror"
                                required>
                                <option value="">-- Select Teacher --</option>
                                @foreach($teachers as $teacher)
                                <option value="{{ $teacher->id }}" {{ (string)old('teacher_id', $course->teacher_id ??
                                    '') === (string)$teacher->id ? 'selected' : '' }}>
                                    {{ $teacher->teacherDetail->first_name ?? $teacher->name }} {{
                                    $teacher->teacherDetail->last_name ?? '' }}
                                </option>
                                @endforeach
                            </select>
                            @error('teacher_id')
