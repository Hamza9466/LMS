    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-lg-12">
            <div class="card shadow-sm border-0 rounded-3">
                ...
                <div class="card-body">
                    {{-- show validation + success messages --}}
                    @if ($errors->any())
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('courses.update', $course->id) }}">
                        ...
                        {{-- Title + Slug (slug read-only; controller keeps it if provided) --}}
                        <div class="row g-3">
                            <div class="col-md-8">
                        ...
                        {{-- Pricing (no JS; server will ignore when free) --}}
                        <div class="row g-3 mt-1">
                            <div class="col-md-2 d-flex align-items-end">
                                {{-- hidden 0 ensures a value is always sent --}}
