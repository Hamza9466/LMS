...
@php
/**
 * Display name/label consistently:
 * - Admin/Teacher => show role (Admin/Teacher)
 * - Student       => show full name (from studentDetail) or username; fallback to "Student #ID"
 */
...
$canModerate = in_array(auth()->user()->role ?? 'student', ['admin','teacher']);
@endphp
