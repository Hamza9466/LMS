...
@section('content')
    <!-- Page Banner Section Start -->
                ...
                <div class="container">
                    ...
                    <div class="page-breadcrumb">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Zoom Meetings and Webinars</li>
                        </ul>
                    </div>
                    <!-- Page Breadcrumb End -->
                    ...
                    <div class="page-banner__caption text-center">
                        <h2 class="page-banner__main-title">Zoom Meetings and Webinars</h2>
                    </div>
        ...
        <!-- Zoom Meetings Section Start -->
        <div class="zoom-meetings-section section-padding-01">
...
@foreach ($meetings as $meeting)
  <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1000">
    <div class="zoom-meetings-item">
      <div class="zoom-meetings-item__thumbnail">
        <img
          src="{{ $meeting->image_path ? asset($meeting->image_path) : asset('assets/images/zoom-meetings/zoom-meeting-01.jpg') }}"
          alt="{{ $meeting->title }}" width="370" height="246">
      </div>

      <div class="zoom-meetings-item__caption">
        <h2 class="zoom-meetings-item__title">{{ $meeting->title }}</h2>

      <div class="zoom-meetings-item__id">
  <span class="label">Meeting ID: </span>
  <a class="value" href="https://zoom.us/j/{{ $meeting->meeting_id }}" target="_blank" rel="noopener">
    {{ $meeting->meeting_id }}
  </a>
</div>

        <div class="zoom-meetings-item__meta">
          <p class="zoom-meetings-item__meta-action">
            <i class="fas fa-calendar"></i>
            {{ optional($meeting->starts_at)->format('M d, Y g:i A') }}
          </p>

          @php
            $mins = (int) $meeting->duration_minutes;
            $h = intdiv($mins, 60);
            $m = $mins % 60;
            $dur = $h ? ($m ? "{$h}h:{$m}m" : "{$h}h") : "{$m}m";
          @endphp
          <p class="zoom-meetings-item__meta-action">
            <i class="fas fa-clock"></i> {{ $dur }}
          </p>
        </div>
      </div>
    </div>
